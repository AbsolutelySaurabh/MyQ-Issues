...
//                                dat.put("emailaddress", email);
//                                dat.put("password", "1234");
//                                dat.put("username", object.optString("name"));
//                                dat.put("gender", object.optString("gender"));
//                                dat.put("aboutme", "newbie");
//                                dat.put("dob", "2017/04/11");
//                                dat.put("devicetype", "android");
//                                dat.put("deviceid", "1234");
//                                dat.put("source", "facebook");
//                                dat.put("profilepicture", Config.defaultprofilepic);
//                                dat.put("fbid", object.optString("id"));
//                                dat.put("googleplusid", "1234");
...
//
//                                sessionManager.createLoginSession(uid, object.optString("name"), "fff",email,"jiit","2017/04/16",object.optString("gender"));
...
//        editor.putString("reader2", ""+reader2);
    ...
    public void socialfb(final String userid, final String username, final String profilepic, final String email, final String aboutme, final String dob, final String gender) {
        ...
        String s="http://myish.com:10010/api/sociallogin";
